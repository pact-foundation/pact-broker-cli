...
${BIN} pact-broker can-i-merge --pacticipant foo
${BIN} pact-broker create-or-update-pacticipant --name foo --main-branch bar --repository-url http://foo.bar
...
${BIN} pact-broker create-or-update-webhook http//foo.bar --uuid bar --help
${BIN} pact-broker test-webhook --uuid bar || echo "test-webhook unimplemented"
${BIN} pact-broker delete-branch --branch foo --pacticipant foo
${BIN} pact-broker create-version-tag --version foo --pacticipant foo --tag bar
${BIN} pact-broker describe-version --pacticipant foo
${BIN} pact-broker create-or-update-version --version foo --pacticipant foo --branch bar --tags baz
